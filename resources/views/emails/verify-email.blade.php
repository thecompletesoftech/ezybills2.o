...
<body>
  <div class="wrapper">
    <div class="header">
      <h1>EzyBills POS</h1>
      <p>Smart Billing for Smart Businesses</p>
    </div>
    <div class="body">
      <p>Hi <strong>{{ $userName }}</strong>,</p>
      <p>Thanks for signing up for EzyBills! Please verify your email address to activate your account and start billing.</p>
      <div class="btn-wrap">
